    ...
    return (
      <div className="flex items-center justify-center min-h-screen bg-background p-4">
        <div className="text-center">
          ...
          <h1 className="mt-4 text-2xl font-bold text-foreground">Chargement de la norme...</h1>
          <p className="mt-2 text-lg text-muted-foreground">La conformité est la clé. Veuillez patienter.</p>
        </div>
      </div>
    );
  }
          ...
          <CardContent>
            {standard.image && (
                <div className="relative aspect-video w-full mb-6">
                    <Image src={standard.image} alt={standard.name} layout="fill" className="rounded-lg object-cover" data-ai-hint="certificate document"/>
                </div>
            )}
