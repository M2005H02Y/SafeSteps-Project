            ...
            <CardContent className="p-4 space-y-4">
                ...
                <div className="space-y-2 text-sm">
                    <div className="flex gap-2">
                        <span className="font-semibold shrink-0">Catégorie:</span>
                        <span className="text-muted-foreground break-all">{data.category}</span>
                    </div>
                    <div className="flex items-center gap-2">
                        <span className="font-semibold">Version:</span>
                        <span className="text-muted-foreground break-all">{data.version}</span>
                    </div>
                </div>
